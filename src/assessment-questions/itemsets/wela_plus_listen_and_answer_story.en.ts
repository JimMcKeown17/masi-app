...
// PLACEHOLDER content — real pedagogy-supplied story + prompts land in #34.
// Stub-marked item_set_id so any captured run is distinguishable.
export const WELA_PLUS_LISTEN_AND_ANSWER_STORY_EN: ItemSet<ListenAndAnswerStoryItemSet> = {
  item_set_id: 'wela_plus_listen_and_answer_story@stub-2026-06-02.en',

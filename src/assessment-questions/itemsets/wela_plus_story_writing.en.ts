...
// PLACEHOLDER content — real WelaPLUS picture cards + anchors land in #34.
// The four dimension codes (meaning_making, spelling, length, vocabulary)
// are load-bearing for ADR-0004: item_key = 'ea:<code>' on the EA-written
// rows, 'hq:<code>' on the future HQ-inserted rows.
export const WELA_PLUS_STORY_WRITING_EN: ItemSet<StoryWritingRubricItemSet> = {
  item_set_id: 'wela_plus_story_writing@stub-2026-06-04.en',

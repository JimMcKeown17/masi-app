...
describe('getSessionsTodayGoal', () => {
  ...
  test("computes the goal from only today's active-programme sessions", async () => {
    ...
    sessionsRepository.getSessions.mockResolvedValue([
      { id: 's1', programme_id: 'prog-literacy', session_date: '2026-05-29' }, // today + active → counts
      { id: 's2', programme_id: 'prog-literacy', session_date: '2026-05-28' }, // active, yesterday → excluded
      { id: 's3', programme_id: 'prog-other', session_date: '2026-05-29' },    // today, other programme → excluded
    ]);

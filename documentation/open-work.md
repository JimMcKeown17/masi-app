...
4. **P2, sync efficiency and recovery:** expand safe batching and add SQLite bootstrap recovery (§1, §2, §3). Domain-pull queue monopolies, outbox `created_at` stability, redundant enqueue writes, and batch claim rereads were closed 2026-07-14.
